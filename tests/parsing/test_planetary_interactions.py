...
class PlanetaryInteractionsTestCase(unittest.TestCase):
    ...
    def test_parse_planetary_pins(self):
        ...
        self.assertEqual(result, {
            1018352222277: {'content': {'name': '', 'quantity': 0, 'type': 0},
                            'cycle_time': 0,
                            'expiry_ts': None,
                            'id': 1018352222277L,
                            'install_ts': None,
            ...
            1018352251143: {'content': {'name': '', 'quantity': 0, 'type': 0},
                            'cycle_time': 30,
            ...
            1018352251145: {'content': {'name': 'Aqueous Liquids',
                                        'quantity': 3000,
                                        'type': 2268},
                            'cycle_time': 0,
                            'expiry_ts': None,
            ...
            1018352251149: {'content': {'name': 'Industrial Fibers',
                                        'quantity': 40,
                                        'type': 2397},
                            'cycle_time': 0,
                            'expiry_ts': None,
            ...
            1018352251151: {'content': {'name': 'Silicon',
                                        'quantity': 2760,
                                        'type': 9828},
                            'cycle_time': 0,
                            'expiry_ts': None,
            ...
            1018352251153: {'content': {'name': 'Industrial Fibers',
                                        'quantity': 2600,
                                        'type': 2397},
                            'cycle_time': 0,
                            'expiry_ts': None,
